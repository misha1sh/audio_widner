...
if(WIN32)
    ...
    set(IPP_LIBS ipp_iw.lib   ippchmt.lib    ippcvmt.lib  ippemt.lib  ippsmt.lib
            ippcc.lib    ippcore.lib    ippdc.lib    ippi.lib    ippvm.lib
            ippccmt.lib  ippcoremt.lib  ippdcmt.lib  ippimt.lib  ippvmmt.lib
            ippch.lib    ippcv.lib      ippe.lib     ipps.lib )
elseif(APPLE)
